...
var caESPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Selecciona ${views2[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Hora no seleccionada" : `L'hora seleccionada és ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var elGRPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Επιλέξτε ${views3[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Δεν έχει επιλεγεί ώρα" : `Η επιλεγμένη ώρα είναι ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var esESPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Seleccione ${views4[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "No hay hora seleccionada" : `La hora seleccionada es ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var euPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Aukeratu ${views5[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Ez da ordurik aukertau" : `Aukeratutako ordua ${formattedTime ?? utils.format(time, "fullTime")} da`}`,
...
var fiFIPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Valitse ${views6[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Ei aikaa valittuna" : `Valittu aika on ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var frFRPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Choix des ${views7[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Aucune heure choisie" : `L'heure choisie est ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var heILPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `בחירת ${views8[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "לא נבחרה שעה" : `השעה הנבחרת היא ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var huHUPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `${timeViews5[view] ?? view} kiválasztása. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Nincs kiválasztva idő" : `A kiválasztott idő ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var isISPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Velja ${timeViews6[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Enginn tími valinn" : `Valinn tími er ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var itITPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Seleziona ${views9[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Nessun orario selezionato" : `L'ora selezionata è ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var jaJPPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `${timeViews7[view] ?? view}を選択してください ${!formattedTime && (time === null || !utils.isValid(time)) ? "時間が選択されていません" : `選択した時間は ${formattedTime ?? utils.format(time, "fullTime")} です`}`,
...
var koKRPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `${views10[view]} 선택하세요. ${!formattedTime && (time === null || !utils.isValid(time)) ? "시간을 선택하지 않았습니다." : `현재 선택된 시간은 ${formattedTime ?? utils.format(time, "fullTime")}입니다.`}`,
...
var kzKZPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `${timeViews8[view]} таңдау. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Уақыт таңдалмаған" : `Таңдалған уақыт ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var nbNOPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Velg ${timeViews9[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Ingen tid valgt" : `Valgt tid er ${formattedTime ?? utils.format(time, "fullTime")}`}`,
  hoursClockNumberText: (hours) => `${hours} timer`,
  minutesClockNumberText: (minutes) => `${minutes} minutter`,
  secondsClockNumberText: (seconds) => `${seconds} sekunder`,
  // Digital clock labels
...
var nlNLPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Selecteer ${timeViews10[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Geen tijd geselecteerd" : `Geselecteerde tijd is ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var nnNOPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Vel ${timeViews11[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Ingen tid vald" : `Vald tid er ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var plPLPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Wybierz ${timeViews12[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Nie wybrano czasu" : `Wybrany czas to ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var ptBRPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Selecione ${timeViews13[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Hora não selecionada" : `Selecionado a hora ${formattedTime ?? utils.format(time, "fullTime")}`}`,
  hoursClockNumberText: (hours) => `${hours} horas`,
  minutesClockNumberText: (minutes) => `${minutes} minutos`,
  secondsClockNumberText: (seconds) => `${seconds} segundos`,
  // Digital clock labels
...
var roROPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Selectați ${timeViews14[view] ?? view}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Nicio oră selectată" : `Ora selectată este ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var ruRUPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Выбрать ${timeViews15[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Время не выбрано" : `Выбрано время ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var skSKPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `${timeViews16[view] ?? view} vybraný. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Nie je vybraný čas" : `Vybraný čas je ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var svSEPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Välj ${timeViews17[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Ingen tid vald" : `Vald tid är ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var trTRPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `${timeViews18[view]} seç.  ${!formattedTime && (time === null || !utils.isValid(time)) ? "Zaman seçilmedi" : `Seçilen zaman: ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var ukUAPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Вибрати ${timeViews19[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Час не вибраний" : `Вибрано час ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var urPKPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `${timeViews20[view]} منتخب کریں ${!formattedTime && (time === null || !utils.isValid(time)) ? "کوئی وقت منتخب نہیں" : `منتخب وقت ہے ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var viVNPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `Chọn ${views11[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "Không có giờ được chọn" : `Giờ được chọn là ${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var zhCNPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `选择 ${views12[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "未选择时间" : `已选择${formattedTime ?? utils.format(time, "fullTime")}`}`,
...
var zhHKPickers = {
  ...
  // Clock labels
  clockLabelText: (view, time, utils, formattedTime) => `選擇 ${views13[view]}. ${!formattedTime && (time === null || !utils.isValid(time)) ? "未選擇時間" : `已選擇${formattedTime ?? utils.format(time, "fullTime")}`}`,
